...
parser.add_argument('--train_dir', default='figaro', help='path to dataset')
parser.add_argument('--valid_dir', default='figaro_valid', help='path to dataset')
...
parser.add_argument('--valid_sample_dir', default='samples', help='folder to output images and model checkpoints')
