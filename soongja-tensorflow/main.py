...
flags.DEFINE_integer("epoch", 20, "Epochs to train")
...
flags.DEFINE_string("data_dir", "dataset/hairdata", "Root directory of your dataset(Don't use . or /")
flags.DEFINE_string("data_name", "hairdata", "Used for folder names of ckpts, logs, etc.(do not use . or /")
