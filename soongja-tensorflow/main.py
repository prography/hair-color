...
flags.DEFINE_integer("batch_size", 8, "The size of image batches")
...
flags.DEFINE_string("data_dir", "../dataset/lfw-png", "Root directory of your dataset(Don't use . or /")
flags.DEFINE_string("data_name", "lfw-png", "Used for folder names of ckpts, logs, etc.(do not use . or /")
