...
flags.DEFINE_integer("batch_size", 1, "The size of image batches. Must be smaller than # of train images []")
...
flags.DEFINE_string("data_dir", "lfw", "Root directory of your dataset []")
